...
extension ExampleStrings {
    static let g7: [String: [String: String]] = [
        "en": [
            ...
            "page.textInput.submitSection": "Submit actions · .onSubmit / .submitLabel",
            "page.textInput.submitExplain": "One .onSubmit on the fields' container fires when Return is pressed in either — and composes with a field's own .onSubmit. .submitLabel is accepted for parity (no on-screen Return key in a terminal).",
            "page.textInput.submitName": "Name",
            "page.textInput.submitEmail": "Email",
            "page.textInput.submitForm": "form submitted",
            "page.textInput.submitEmailCommitted": "email field committed",
            "page.textInput.submitHint": "Type in a field and press Return to submit.",
